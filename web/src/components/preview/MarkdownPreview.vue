...
.markdown-body :deep(h1) { font-size: 2em; border-bottom: 1px solid var(--border-default); padding-bottom: 0.3em; }
.markdown-body :deep(h2) { font-size: 1.5em; border-bottom: 1px solid var(--border-default); padding-bottom: 0.3em; }
